...
# This script includes the decrease space function. It needs to be merged with Tara's latest work.
...
##/
source("C:/code/JavaModules/tlumip/src/R/ald/ald_inputs_103.R")
...
nivq <- nivqData[currYear, 2:3] # Note: assumes that the first line is the first year after the base year
...
write.table(totQ.af, paste(ALDCurrDirectory, "FloorspaceInventory.csv", sep="/"), row.names=TRUE, col.names=TRUE, sep=",")
