...
cf$rBq1["FLR MH"]                       <- 0.0001   # equation 02, Bq1 for FLR MH
cf$rBq1["FLR MF"]                       <- 0.0001   # equation 02, Bq1 for FLR MF
cf$rBq1["FLR AT"]                       <- 0.0001   # equation 02, Bq1 for FLR AT
cf$rBq1["FLR SFD"]                      <- 0.0001   # equation 02, Bq1 for FLR SFD
cf$rBq1["FLR RRMH"]                     <- 0.0001   # equation 02, Bq1 for FLR RRMH
cf$rBq1["FLR RRSFD"]                    <- 0.0001   # equation 02, Bq1 for FLR RRSFD
cf$nBq1["FLR Accommodation"]            <- 0.0001   # equation 02, Bq1 for FLR Accommodation
cf$nBq1["FLR Depot"]                    <- 0.0001   # equation 02, Bq1 for FLR Depot
cf$nBq1["FLR Government Support"]       <- 0.0001   # equation 02, Bq1 for FLR Government Support
cf$nBq1["FLR Grade-school"]             <- 0.0001   # equation 02, Bq1 for FLR Grade-school
cf$nBq1["FLR Heavy Industry"]           <- 0.0001   # equation 02, Bq1 for FLR Heavy Industry
cf$nBq1["FLR Hospital"]                 <- 0.0001   # equation 02, Bq1 for FLR Hospital
cf$nBq1["FLR Institutional"]            <- 0.0001   # equation 02, Bq1 for FLR Institutional
cf$nBq1["FLR Light Industry"]           <- 0.0001   # equation 02, Bq1 for FLR Light Industry
cf$nBq1["FLR Office"]                   <- 0.0001   # equation 02, Bq1 for FLR Office
cf$nBq1["FLR Retail"]                   <- 0.0001   # equation 02, Bq1 for FLR Retail
cf$nBq1["FLR Warehouse"]                <- 0.0001   # equation 02, Bq1 for FLR Warehouse
