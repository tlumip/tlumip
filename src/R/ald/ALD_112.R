...
##/
 # writeTmTable
 # This function writes a matrix or data frame file in the form expected by other TM modules:
 # Headers for all fields and rownames in the first column
 # @param x - a matrix or data frame
 # @param colNm - the name for the first column which will contain the row names
 # @param fileNm - the file name
 # @return none
##/
writeTmTable <- function(x, ColNm, FileNm){
     if(is.matrix(x)) x <- data.frame(x)
     x <- cbind(rownames(x), x)
     colnames(x)[1] <- ColNm
     write.table(x, FileNm, row.names=FALSE, col.names=TRUE, sep=",")
     }
...
writeTmTable(floorOut, ColNm="FLRName", FileNm=paste(ALDCurrDirectory, "FloorspaceDiagnostics.csv", sep="/"))
rm(floorOut)
...
##/
writeTmTable(floorspaceCapacities$res, ColNm="AZone", FileNm=paste(ALDCurrDirectory, "ResidentialCapacity.csv", sep="/"))
writeTmTable(floorspaceCapacities$nres, ColNm="AZone", FileNm=paste(ALDCurrDirectory, "NonresidentialCapacity.csv", sep="/"))
writeTmTable(floorspaceCapacities$floorspaceProp, ColNm="FLRName", FileNm=paste(ALDCurrDirectory, "FloorspaceProportionsByZoning.csv", sep="/"))
writeTmTable(floorspaceCapacities$landAllocations, ColNm="AZone", FileNm=paste(ALDCurrDirectory, "LandAllocations.csv", sep="/"))
...
##/
writeTmTable(resDQ$A.af, ColNm="AZone", FileNm=paste(ALDCurrDirectory, "ResidentialDecreaseUtilities.csv", sep="/"))
writeTmTable(resDQ$DQ.af, ColNm="AZone", FileNm=paste(ALDCurrDirectory, "ResidentialDecrease.csv", sep="/"))
writeTmTable(nresDQ$A.af, ColNm="AZone", FileNm=paste(ALDCurrDirectory, "NonresidentialDecreaseUtilities.csv", sep="/"))
writeTmTable(nresDQ$DQ.af, ColNm="AZone", FileNm=paste(ALDCurrDirectory, "NonresidentialDecrease.csv", sep="/"))
...
##/
writeTmTable(resQNew$prevDQ.af, ColNm="AZone",
     FileNm=paste(ALDCurrDirectory, "ResQuantitiesAfterDecrease.csv", sep="/"))
writeTmTable(nresQNew$prevDQ.af, ColNm="AZone",
     FileNm=paste(ALDCurrDirectory, "NonresQuantitiesAfterDecrease.csv", sep="/"))
writeTmTable(resQNew$lowCap.af, ColNm="AZone",
     FileNm=paste(ALDCurrDirectory, "ResLowCapacity.csv", sep="/"))
writeTmTable(nresQNew$lowCap.af, ColNm="AZone",
     FileNm=paste(ALDCurrDirectory, "NonresLowCapacity.csv", sep="/"))
writeTmTable(resQNew$B.af, ColNm="AZone",
     FileNm=paste(ALDCurrDirectory, "ResIncreaseUtilities.csv", sep="/"))
writeTmTable(nresQNew$B.af, ColNm="AZone",
     FileNm=paste(ALDCurrDirectory, "NonresIncreaseUtilities.csv", sep="/"))
writeTmTable(resQNew$IQ.af, ColNm="AZone",
     FileNm=paste(ALDCurrDirectory, "ResidentialIncreases.csv", sep="/"))
writeTmTable(nresQNew$IQ.af, ColNm="AZone",
     FileNm=paste(ALDCurrDirectory, "NonresidentialIncreases.csv", sep="/"))
writeTmTable(cbind(resQNew$propCap.af, nresQNew$propCap.af), ColNm="AZone",
     FileNm=paste(ALDCurrDirectory, "CapacityUtilization.csv", sep="/"))
