...
##/
funs$calcFloorCapacity <- function(Lp, compat.fz, zoning.az, far.fz, floorDef){
...
##/
 ...
 ##/
nonresidentialFloorspace <- allocateFloorProd(nivq$nres, price.bf$nres, quant.af$nres, costs$nres$cost, nLq, nBq1, nBq2, asc$nres)
...
##/
floorspaceCapacities <- calcFloorCapacity(Lp, compat.fz, zoning.az, far.fz, floorDef)
