 ...
 * @version  Sep 20, 2005
 */
public class RpcNetworkHandler implements NetworkHandlerIF {

    public static final String HANDLER_NAME = "networkHandler";
    
    protected static transient Logger logger = Logger.getLogger(RpcNetworkHandler.class);

    RpcClient rc = null;



    public RpcNetworkHandler( String rpcConfigFileName ) {
        ...
        try {
            ...
            logger.error( "MalformedURLException caught in RpcNetworkHandler() while defining RpcClient for " + HANDLER_NAME + ".", e);
        }
        catch (Exception e) {
            logger.error( "Exception caught in RpcNetworkHandler() while defining RpcClient for " + HANDLER_NAME + ".", e);
        }
    }
