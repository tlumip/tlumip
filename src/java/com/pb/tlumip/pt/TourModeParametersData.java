...
public class TourModeParametersData {
    ...
    protected static Logger logger = Logger.getLogger(TourModeParametersData.class);
    String tourModeParametersTableName="TourModeParameters";
    
     //an array of TourModeParamter objects corresponding to the various activity purposes
     //Each TourModeParameter object is a row of the TourModeParameters table.
