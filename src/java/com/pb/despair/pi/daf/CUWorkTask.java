...
//        logger.info(" *** + " + getName() + " is getting the pidaf resource bundle");
...
//            reader = new BufferedReader(new FileReader(new File(ResourceUtil.getProperty(pidafRb,"run.param.file"))));
