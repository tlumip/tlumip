...
public class CTModel extends ModelComponent {
	...
	public CTModel(ResourceBundle rb){
		setProperties(rb);    //creates a resource bundle as a class attribute called resourceBundle.
        this.debug = (Boolean.valueOf(ResourceUtil.getProperty(rb, "debug"))).booleanValue();
        logger.info("debug: " + debug);
        this.inputPath = ResourceUtil.getProperty(rb, "ct.base.data");
        logger.info("inputPath: " + inputPath);
        this.outputPath = ResourceUtil.getProperty(rb, "ct.current.data");
        logger.info("outputPath: " + outputPath);
        this.randomSeed = Long.parseLong(ResourceUtil.getProperty(rb, "randomSeed"));
	...
	public void startModel(int t){
        ...
        // binary format.
        FreightDemand3 fd = new FreightDemand3(resourceBundle,debug,inputPath,outputPath,randomSeed);
        ...
        DiscreteShipments2 ds = new DiscreteShipments2(resourceBundle,inputPath,randomSeed);
        ...
        TruckTours4 truckTours = new TruckTours4(resourceBundle,inputPath,randomSeed);
	...
	public static void main (String args[]){
		CTModel ctModel = new CTModel(ResourceUtil.getResourceBundle("ct"));
