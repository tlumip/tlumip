...
public class PatternChoiceParameters {
    ...
    public void readData(ResourceBundle rb, String fileName){
        ...
        try{
            ...
            nWorkBasedTours=                        table.getValueAt(rowNumber, table.getColumnPosition("nWorkBasedTours"));
            ...
            socRecTours=                            table.getValueAt(rowNumber, table.getColumnPosition("socRecTours"));
