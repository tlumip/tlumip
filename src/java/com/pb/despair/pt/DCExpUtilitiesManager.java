...
//            expUtilities[WORK_BASED]=readMatrix(new String("b"),workSegment);
...
//             expUtilities[SCHOOL1]=readMatrix(new String("c1"),nonWorkSegment);
//             expUtilities[SCHOOL3]=readMatrix(new String("c3"),nonWorkSegment);
//             expUtilities[SHOP]=readMatrix(new String("s"),nonWorkSegment);
//             expUtilities[RECREATE]=readMatrix(new String("r"),nonWorkSegment);
//             expUtilities[OTHER]=readMatrix(new String("o"),nonWorkSegment);
